...
private fun Matrix.upRightFrom(
    startX: Int,
    startY: Int,
    includeStart: Boolean = true,
): Sequence<Char> =
...
private fun Matrix.downLeftFrom(
    startX: Int,
    startY: Int,
    includeStart: Boolean = true,
): Sequence<Char> =
...
private fun Matrix.downRightFrom(
    startX: Int,
    startY: Int,
    includeStart: Boolean = true,
): Sequence<Char> =
...
fun Matrix.allCells(): Sequence<Pair<Int, Int>> =
    sequence {
        for (x in 0..<size) {
...
private fun Matrix.countXmasFrom(
    startX: Int,
    startY: Int,
): Int {
